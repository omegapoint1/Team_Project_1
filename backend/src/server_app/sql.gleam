...
pub type LoginWithUserRow {
  LoginWithUserRow(password: String, userid: Int, admin: Option(Bool))
}
...
pub fn login_with_user(
  ...
  let decoder = {
    ...
    decode.success(LoginWithUserRow(password:, userid:, admin:))
  }
...
pub fn quest_get(
  ...
  let decoder = {
    ...
    use isactive <- decode.field(7, decode.optional(decode.bool))
...
pub fn quest_leaderboard_get(
  ...
  let decoder = {
    ...
    use completiontime <- decode.field(2, decode.optional(decode.int))
...
pub fn user_progression_get(
  ...
  let decoder = {
    use userid <- decode.field(0, decode.int)
    use totalxp <- decode.field(1, decode.optional(decode.int))
    use level <- decode.field(2, decode.optional(decode.int))
    use completedquests <- decode.field(3, decode.optional(decode.int))
...
/// A row you get from running the `user_quest_complete` query
/// defined in `./src/server_app/sql/user_quest_complete.sql`.
///
/// > 🐿️ This type definition was generated automatically using v4.6.0 of the
/// > [squirrel package](https://github.com/giacomocavalieri/squirrel).
///
pub type UserQuestCompleteRow {
  UserQuestCompleteRow(userquestid: Int)
}
...
pub fn user_quest_complete(
  ...
  arg_2: Int,
  arg_3: Int,
) -> Result(pog.Returned(UserQuestCompleteRow), pog.QueryError) {
  let decoder = {
    use userquestid <- decode.field(0, decode.int)
    decode.success(UserQuestCompleteRow(userquestid:))
  }
...
pub fn user_quest_get_by_user(
  ...
  let decoder = {
    use userquestid <- decode.field(0, decode.int)
    use userid <- decode.field(1, decode.optional(decode.int))
    use questid <- decode.field(2, decode.optional(decode.int))
    ...
    use status <- decode.field(9, decode.optional(decode.string))
    use progress <- decode.field(10, decode.optional(decode.int))
    use maxprogress <- decode.field(11, decode.optional(decode.int))
    use startedat <- decode.field(12, decode.string)
    use completedat <- decode.field(13, decode.string)
